...
function EmptyState() {
  return (
    ...
    >
      ...
      <p className="text-[11px] tracking-[0.22em] uppercase font-medium" style={{ color: '#5C4638' }}>
        No fragrances found
      </p>
    </motion.div>
  )
...
export default function ProductGrid({ activeFilter }) {
  ...
  return (
    <div className="relative product-catalog-section luxury-section pt-14 pb-24 md:pb-36">
